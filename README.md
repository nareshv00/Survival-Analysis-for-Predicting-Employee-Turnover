...
This is calculated by creating the possible simulations of data without time dependency, if the covariate is time dependent then the actual pattern will be heavily biased the created set of simulations. Using the assess statement in SAS, we have computed the martingale residuals. 
